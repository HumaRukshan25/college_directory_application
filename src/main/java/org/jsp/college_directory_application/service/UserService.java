...
import org.jsp.college_directory_application.entity.UserStatus;
import org.jsp.college_directory_application.exeptionclasses.InvalidCredentialException;
import org.jsp.college_directory_application.responsestructure.ResponseStructure;
import org.jsp.college_directory_application.util.AuthUser;
import org.jsp.college_directory_application.util.MyUtil;
...
//        ResponseStructure<User> responseStructure = ResponseStructure.<User>builder()
...
public class UserService {
	...
	// in userserviceimple sir did i did here only      for sending email  when user save 
	@Autowired
